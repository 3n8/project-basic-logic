...
# Usage: bin/render-master.sh <name> <master.mp4> [inputs_dir] [outputs_dir]
#
...
[ "$#" -ge 2 ] && [ "$#" -le 4 ] || die "usage: render-master.sh <name> <master.mp4> [inputs_dir] [outputs_dir]"
NAME="$1"; MASTER="$2"
...
[ -f "$IN_DIR/music.ogg" ] && MUSIC="$IN_DIR/music.ogg"
