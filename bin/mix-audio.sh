...
# Usage: bin/mix-audio.sh <narration.mp3> <music.ogg|-> <output.wav> [music_volume_linear]
#
...
[ "$#" -ge 3 ] && [ "$#" -le 4 ] || die "usage: mix-audio.sh <narration.mp3> <music.ogg|-> <output.wav> [volume]"
